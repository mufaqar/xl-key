...
function EnterpriseFooter(props) {
                ...
                <div className="pl-3 pr-3">
                    <div class="row">
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    {translation.Experiences}
                                        <br/><br/>
                                        <a className="link-text" href="/entreprise/dashboard">{translation.Dashboard}</a>
                                        <br/><br/>
                                        <a className="link-text" href="/entreprise/upload-d-images">{translation.Photos}</a>
                                        <br/><br/>
                        ...
                        <div class="col-md-4">
                            ...
                            {translation.Account}
                                <br/><br/>
                                <a className="link-text" href="/entreprise/settings/information-general">{translation.Settings}</a>
                                <br/><br/>
