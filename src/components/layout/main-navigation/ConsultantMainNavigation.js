...
function ConsultantMainNavigation(props) {
    ...
    const [userName, setUserName] = React.useState("Consultant");
    ...
    const navigateToHome = () => {
        ...
        } else if (base_url.includes("producteur")) {
            homeUrl = "/producteur/dashboard";
        }
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            {!show ? <Popup anchor={anchor.current} show={!show} popupClass={'popup-content'}>
                ...
                <div className="row">
                    <div className="col-5 ml-5">
                        ...
                        <Link to={base_url+"/liste-des-producteurs"}>
                            <div className="row">
                    ...
                    <div className="col-5 ml-5">
                        <Link to={base_url+"/upload-d-images"}>
                            <div className="row">
            ...
            {props.acc_id != null && (
                <p className="alert-warning pt-3 pb-3 pl-4 pr-4">
                    <span>{translation.Currently_you_are_in_the} {userName} ({translation.Consultant})</span>
...
export default ConsultantMainNavigation;