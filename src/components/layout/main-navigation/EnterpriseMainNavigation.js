...
function EnterpriseMainNavigation(props) {
    ...
    const [userName, setUserName] = React.useState("Enterprise");
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            {!show ? <Popup anchor={anchor.current} show={!show} popupClass={'popup-content'}>
                ...
                <div className="row">
                    <div className="col-5 ml-5">
                        ...
                        <Link to={base_url+"/listes-des-producteurs"}>
                            <div className="row">
                        ...
                        <Link to={base_url+"/listes-des-consultants"}>
                            <div className="row">
            ...
            {props.acc_id != null && (
                <p className="alert-warning pt-3 pb-3 pl-4 pr-4">
                    <span>{translation.Currently_you_are_in_the} {userName} ({translation.Enterprise})</span>
...
export default EnterpriseMainNavigation;