...
class NoteSideNavigation extends React.Component {
    ...
    addPage(e) {
        // e.preventDefault();
        console.log("data  new addPage start addPage", e.target.id);
        const data = this.state.fields;


        console.log("data  new addPage start", data);
        const dataObject = {
    ...
    addPageSubmit(e) {
        e.preventDefault();
        console.log("data  new addPage start addPage 1234", e.target.id);
    ...
    DeletePage = (id) => {
        ...
        this.state.api
            ...
            .then(response => {
                console.log("data  new delete** ", response);
                console.log("data  delete messge** ", response.data.message);


                this.setState({ message: response.data.message });
                console.log("data  delete messages** ", this.state.message);
                // setTimeout(this.state.hideModal.hideModal(), 1000);
                // setTimeout(this.loadData(), 1000);
                setTimeout(window.location.reload(false),500);
    ...
    onTrigger = (pageId, folderId, pageName, folderName, isMobile) => {
        ...
        console.log("iddddddddddddddddddd", pageId )
                                                    ...
                                                    {(folder.pages).map((page) => (
                                                        <div class="inner-service-row-margin-para  " style={{ marginLeft: '30px', marginBottom: '0px', zIndex: '99', position: "relative" }}>
                                                            <div class="row" style={{ backgroundColor: 'white' }}>
                                                                ...
                                                                <div class="col" style={{ paddingRight: '0px' }} onClick={this.onTrigger.bind(null, page.id, folder.id , page.name_fr, folder.name_fr, false)} id={page.id}>
                                                    ...
                                                    {(folder.pages).map((page) => (
                                                        <div class="inner-service-row-margin-para ">
                                                            <div class="row" style={{ backgroundColor: 'white' }}>
                                                                ...
                                                                <div class="row" onClick={this.onTrigger.bind(null, page.id, folder.id , page.name_fr, folder.name_fr, true )} id={page.id}>
                                                                        <div class="col-6 text-left">
                                                                            <div class="previous">
                                                                                <p className="parastyle" name="pageId" value={page.id} style={{ backgroundColor: 'white' }}>{isFrench ? page.name_fr : page.name_en}</p>
                                                                            </div>
