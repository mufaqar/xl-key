...
class Modal extends React.Component {
    ...
    constructor(props) {
        ...
        console.log("passage_id ", this.props.data.passage_id);
    }
    ...
    updateAccount() {
        ...
        this.state.api
            .updatePassage([this.state.id, dataObject])
            .then(response => {
                    console.log("data  new ", response);
                    this.setState({
                        message: response.data.message
                    ...
                    <div class="modal-content modelSizeFullScreencontent">
                        <div class="modal-header">
                            <h5 className="modal-title textColor" id="exampleModalLabel">
                                {this.state.title === "Ajouter une catégorie de Passages" ?
                                    translation.Add_a_Passage_category : this.state.title === "Ajouter un passage" ?
                                        translation.Add_passage : this.state.title === "Renommer la passage" ?
                                            translation.Rename_the_passage : this.state.title}
                            </h5>
