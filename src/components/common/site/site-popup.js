...
class Modal extends React.Component {
    ...
    updateAccount() {
        ...
        this.state.api
            .updateSite([this.state.id, dataObject])
            .then(response => {
                    console.log("data  new ", response);
                    this.setState({
                        message: response.data.message
                    ...
                    <div class="modal-content modelSizeFullScreencontent">
                        <div class="modal-header">
                            <h5 className="modal-title textColor" id="exampleModalLabel">
                                {this.state.title === "Ajouter un site" ?
                                    translation.Add_a_site : this.state.title === "Renommer la site" ?
                                        translation.Rename_the_site : this.state.title}
                            </h5>
                                ...
                                <div className="col-md-9 col-lg-8 mx-auto">
                                    <form name="addUserform" onSubmit={this.addOrUpdateSubmit.bind(this)}>
                                        ...
                                        <div class="container-fluid">
                                            <div class="row">
                                                <button type="submit"
                                                        class="btn btn-primary ml-auto primaryTop mobile_button">Soumettre
                                                </button>
                                            </div>
                                        </div>
                                        <div class="vspace1em"></div>
