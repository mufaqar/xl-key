...
class Modal extends React.Component {
    ...
    updateAccount() {
        ...
        this.state.api
            .updateCategory([this.state.id, dataObject])
            .then(response => {
                    console.log("data  new ", response);
                    this.setState({
                        message: response.data.message
                    ...
                    <div class="modal-content modelSizeFullScreencontent">
                        <div class="modal-header">
                            <h5 className="modal-title textColor" id="exampleModalLabel">
                                {this.state.title === "Ajouter une catégorie de categories" ?
                                    translation.Add_a_category_of_categories : this.state.title === "Ajouter un category" ?
                                        translation.Add_a_Name_of_the_culture : this.state.title === "Renommer la catégorie" ?
                                            translation.Rename_Name_of_the_culture : this.state.title}
                            </h5>
