...
class Modal extends React.Component {
    ...
    addSubscription() {
        ...
        formData.append('pdf_type', 'contract');
    ...
    render() {
        ...
        return (
            <div class="modal fade" id="addContractPopup" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                 aria-hidden="true">
                <div class="modal-dialog modelSizeFullScreenDialog " role="document">
                    <div class="modal-content modelSizeFullScreencontent">
                        <div class="modal-header">
                            <h5 className="modal-title textColor" id="exampleModalLabel">{translation.Add_a_farm_contract}</h5>
