                  ...
                  <div class="form-label-group">
                    ...
                    <div>
                      <div class="input-group">
                        <select class="form-select form-control" id="language_pref" aria-label="Default select example" value={this.props.type == "update"? this.state.language_pref  : ""}  onChange={this.handleInputChage.bind(this)} >
