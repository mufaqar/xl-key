...
import DeletePopUp from '../../../components/enterprise/settings/delete';
...
class InformationConnection extends React.Component {
    constructor(props) {
        super(props)
                                                            ...
                                                            <div class="row ">
                                                                <div id="small-img"
                                                                    ...
                                                                    <img  onClick={this.handleClick.bind(this)} id={item.id} 
                                                                        ...
                                                                        <DeletePopUp id ={"exampleModaldelete"+item.id} dataId= {item.id} type = {"setting"} acc_id={this.state.acc_id}></DeletePopUp>
                                                                    </ul>
                                                                </div>
                                                            </div>
                                                        </div>
...
export default connect(mapStateToProps, null)(withLanguageHook(InformationConnection));